...
class Transaction_13 extends StatefulWidget {
  const Transaction_13({Key? key}) : super(key: key);

  @override
  State<Transaction_13> createState() => _Transaction_13State();
}

class _Transaction_13State extends State<Transaction_13> {
  int selectedUp = 0;
